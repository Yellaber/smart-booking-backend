...
export class CategoriesController {
  ...
  @Get()
  @ApiResponse({ status: 200, description: 'Categories retrieved successfully.', type: [ CategoryResponse ] })
  ...
  @ApiResponse({ status: 200, description: 'Category retrieved successfully.', type: CategoryResponse })
  @ApiResponse({ status: 401, description: 'Unauthorized. Token related.' })
  @ApiResponse({ status: 403, description: 'Forbidden. User does not have permission to access this resource.' })
